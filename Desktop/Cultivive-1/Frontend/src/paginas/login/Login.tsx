...
import farmer from '../../components/img/farmer.jpg';
            ...
            <Paper elevation={15} className='paperStyle-login'>
                <form onSubmit={logar}>
                    <Box className='box-login'>
                        ...
                        <TextField className="usuario" value={userLogin.usuario} onChange={(e: ChangeEvent<HTMLInputElement>) => updatedModel(e)} id='usuario' label='Usuário' variant='outlined' name='usuario' margin='normal' fullWidth />
                        <TextField className="senha" value={userLogin.senha} onChange={(e: ChangeEvent<HTMLInputElement>) => updatedModel(e)} id='senha' label='Senha' variant='outlined' name='senha' margin='normal' type='password' fullWidth />
                    </Box>
